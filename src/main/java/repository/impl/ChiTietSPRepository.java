...
//    public List<ChiTietSP> search(String ma) {
...
//                    + "ct.idOCung.ten , ct.idHang.ten ,ct.serial ,ct.gia , ct.tinhTrang)"
//                    + "FROM ChiTietSP ct WHERE "
//                    + "ct.idSanPham.ten LIKE CONCAT('%',:ten,'%')"
//                    + "OR ct.idCPU.ten LIKE CONCAT('%',:ten,'%')"
//                    + "OR ct.idCard.ten LIKE CONCAT('%',:ten,'%')"
//                    + "OR ct.gia LIKE CONCAT('%',:gia,'%')"
//                    + "OR ct.idHang.ten LIKE CONCAT('%',:ten,'%')"
//                    + "OR ct.idRam.ten LIKE CONCAT('%',:ten,'%')"
//                    + "OR ct.idOCung.ten LIKE CONCAT('%',:ten,'%')"
//                    + "OR ct.serial LIKE CONCAT('%',:serial,'%')"
//                    + "OR ct.tinhTrang LIKE CONCAT('%',:tinhTrang,'%')"
//                    + "GROUP BY ct.idSanPham.ten, ct.idCPU.ten, "
//                    + "ct.idRam.ten, ct.idCard.ten, ct.idOCung.ten, ct.idHang.ten, ct.tinhTrang, ct.gia , ct.serial");
...
//            query.setParameter("ten", ma);
//            query.setParameter("ten", ma);
//            query.setParameter("serial", ma);
//            query.setParameter("tinhTrang", ma);
